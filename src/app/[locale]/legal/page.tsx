	...
	return (
		<section className="legal-page">
			<header className="legal-hero site-container">
				...
				<p>By using this public preview, you agree to play fair enough for the software to function—even when the rules let you bluff.</p>
			...
			<div className="legal-shell site-container">
				...
				<article className="legal-copy">
					...
					<section><span>03</span><div><h2>RULES + AVAILABILITY</h2><p>The published game rules control this digital version. The rules, computer strategy, features, and availability may be corrected, changed, suspended, or withdrawn as the game evolves. Local progress can still be lost if browser storage is cleared, blocked, corrupted, or removed by private-browsing settings.</p><Link className="legal-link" href={localizedPath('/rules', locale)}>READ THE RULES <b>→</b></Link></div></section>
					...
					<section><span>05</span><div><h2>NO WARRANTY</h2><p>The public preview is provided “as is” and “as available,” without warranties to the extent permitted by law. The operator is not responsible for lost game progress, interruptions, device issues, or indirect losses resulting from use of the preview.</p></div></section>
					<section><span>06</span><div><h2>CHANGES + QUESTIONS</h2><p>Continued use after updated terms are posted means you accept the revised terms. For questions, contact the site operator through the channel that shared this game.</p></div></section>
				</article>
			</div>
		</section>
	)
